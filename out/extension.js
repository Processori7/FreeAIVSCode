...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(FreeAIToolsViewProvider.viewType, provider));
...
class FreeAIToolsViewProvider {
    ...
    openInWebview(url) {
        ...
        const panel = vscode.window.createWebviewPanel('aiToolWebview', 'AI Tool', vscode.ViewColumn.One, {
            enableScripts: true,
...
FreeAIToolsViewProvider.viewType = 'freeAIToolsView';
function adaptJavaScriptForVSCode(js) {
